...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> createUserHandler(@RequestBody User user) throws Exception {
        ...
        Cart cart = new Cart();
        // This line seems incorrect — likely should associate savedUser with the cart instead of casting to List<CartItem>
        cart.setCertItems((List<CartItem>) savedUser);
